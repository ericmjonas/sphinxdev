...
#        self.table.had_head = True
    ...
    def visit_image(self, node):
        ...
        if attrs.has_key('scale'):
            ...
            post.append('}')
        if attrs.has_key('latexwidth') :
            include_graphics_options.append('width=%s' % attrs['latexwidth'])
        else:
        ...
        if attrs.has_key('latexangle') :
            include_graphics_options.append('angle=%s' % attrs['latexangle'])
